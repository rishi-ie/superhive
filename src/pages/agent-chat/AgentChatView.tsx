...
import { PlusSignIcon, HandIcon, ArrowDown01Icon, ArrowUp01Icon, Mic01Icon, NotebookIcon } from "@hugeicons/core-free-icons";
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="shrink-0">
        <div className="max-w-[700px] mx-auto px-14 py-4">
          <div className="relative w-full max-w-[700px]">
            ...
            <div className="relative z-20 flex items-center gap-2 px-4 py-3 max-w-[690px] mx-auto">
              ...
              <span className="text-sm text-white">Ask Anything</span>
            </div>
          </div>
        </div>
      </div>
