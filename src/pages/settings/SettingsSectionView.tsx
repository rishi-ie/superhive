...
export function SettingsSectionView() {
  ...
  return (
    <div className="settings-scroll flex h-full w-full flex-col bg-background overflow-y-auto">
      <div className="flex flex-col gap-6 max-w-[800px] w-full mx-auto px-6 pt-20 pb-4">
