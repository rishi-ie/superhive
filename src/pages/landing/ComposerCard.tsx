...
export function ComposerCard() {
  return (
    <div className="relative w-full max-w-[700px]">
      ...
      <div className="relative z-20 flex items-center gap-stack rounded-b-3xl border-t border-sidebar-border bg-muted px-composer py-list-item max-w-[690px] mx-auto">
        <Icon icon={NotebookIcon} className="size-4 text-sidebar-foreground" />
        <span className="text-sm text-sidebar-foreground">Choose project</span>
      </div>
    </div>
  );
}
