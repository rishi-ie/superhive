...
import { CenterWorkspace } from '@/pages/CenterWorkspace/CenterWorkspace';
import { RightAuxiliary } from '@/pages/RightAuxiliary/RightAuxiliary';
...
import type { ActiveAgent } from '@/pages/LeftNav/ActiveSection';
import type { ArchivedProjectSummary } from '@/pages/LeftNav/ArchivedProjectsSection';
import { listWorkspaces } from '@/data/workspace/store';
import { getProject, getProjectByWorkspace, listProjectAgents, listProjects } from '@/data/project/store';
import { listUniversalTickets } from '@/data/ticket/store';
...
import type { CenterTabType, CenterTab } from '@/data/tab/interface';
import type { Workspace } from '@/data/workspace/interface';
import type { FavoriteItem } from '@/data/favorite/interface';
import {
  getRightPanelTabs,
