  ...
  if (showStatus && status === 'active') {
    return (
      <button
        type="button"
        onClick={onClick}
        className="group flex h-16 w-full cursor-default flex-col items-stretch gap-0 overflow-hidden rounded-lg px-2 py-1 text-sm text-foreground/80 transition-colors hover:bg-sidebar-accent hover:text-foreground"
      >
  ...
  if (showStatus) {
    return (
      <button
        type="button"
        onClick={onClick}
        className="group flex h-8 w-full cursor-default items-center gap-2 rounded-lg px-2 text-sm text-foreground/80 transition-colors hover:bg-sidebar-accent hover:text-foreground"
      >
