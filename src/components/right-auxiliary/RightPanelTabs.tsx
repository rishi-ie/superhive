...
type RightPanelTabsProps = {
  tabs: ReadonlyArray<{ id: string; label: string; icon: React.ComponentType<{ size?: number; strokeWidth?: number }> }>;
  activeTab: string;
  onTabChange: (id: string) => void;
  onRefresh?: () => void;
};

export function RightPanelTabs({ tabs, activeTab, onTabChange, onRefresh }: RightPanelTabsProps) {
  return (
