...
export const agents = {
  ...
  ensureReady: (id: string): Promise<RuntimeStatusPayload> => window.api.agents.ensureReady(id),
  abortTurn: (id: string): Promise<{ ok: boolean }> => window.api.agents.abortTurn(id),
